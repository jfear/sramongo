#!/bin/bash
# Copied from pybedtools
# https://github.com/daler/pybedtools/blob/master/build-docs.sh
...
DOCSOURCE=$HERE/docs/_build/html
TMPREPO=/tmp/docs
rm -rf $TMPREPO
mkdir -p -m 0755 $TMPREPO
git clone git@github.com:jfear/sra2mongo.git $TMPREPO
cd $TMPREPO
